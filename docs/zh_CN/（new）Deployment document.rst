...
1. ``tar xvf ~/flato-backup.tar.gz ~/``
2. ``cp ~/flato/configuration/dynamic.toml /opt/flato/configuration/dynamic.toml``
3. ``cp ~/flato/configuration/global/ns_dynamic.toml /opt/flato/configuration/global/ns_dynamic.toml``
